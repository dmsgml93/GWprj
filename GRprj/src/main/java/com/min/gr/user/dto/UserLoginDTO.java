...
public class UserLoginDTO {
	...
	public UserLoginDTO(String user_id, String user_password) {
		super();
	...
	public String toString() {
		return "UserLoginDTO [user_id=" + user_id + ", user_password=" + user_password + ", user_auth=" + user_auth
				+ ", user_delflag=" + user_delflag + ", user_deldate=" + user_deldate + ", user_lastlogin="
				+ user_lastlogin + "]";
	}
